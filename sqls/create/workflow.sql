/*
 ...
 Source Server         : 161.189.137.213-生产环境(business)
 Source Server Type    : MySQL
 Source Server Version : 80026
 Source Host           : 161.189.137.213:8112
...
CREATE TABLE `act_hi_taskinst` (
  ...
  `FORM_KEY_` text COLLATE utf8_bin,
...
-- ----------------------------
-- Table structure for ext_deployment_info
-- ----------------------------
DROP TABLE IF EXISTS `ext_deployment_info`;
CREATE TABLE `ext_deployment_info` (
  `id` varchar(32) COLLATE utf8mb4_general_ci NOT NULL COMMENT '主键',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建日期',
  `creator` varchar(36) COLLATE utf8mb4_general_ci DEFAULT '' COMMENT '创建人',
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新日期',
  `updater` varchar(36) COLLATE utf8mb4_general_ci DEFAULT '' COMMENT '更新人',
  `ent_code` varchar(255) COLLATE utf8mb4_general_ci NOT NULL COMMENT '企业编码',
  `ent_name` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '企业名称',
  `record_id` varchar(64) COLLATE utf8mb4_general_ci NOT NULL COMMENT '主键id',
  `name` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '流程名称',
  `deployment_id` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '模型id',
  ...
  `record_status` enum('DRAFT','PENDING','ENABLE','DISABLE','DELETED') COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '状态 DRAFT:草稿  PENDING:待发布  ENABLE:启用  DISABLE:禁用',
  `model_xml` longtext COLLATE utf8mb4_general_ci COMMENT '模型xml文本',
  PRIMARY KEY (`id`),
  UNIQUE KEY `record_id` (`record_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='模型信息扩展表';

-- ----------------------------
-- Table structure for ext_task_auditors
-- ----------------------------
DROP TABLE IF EXISTS `ext_task_auditors`;
CREATE TABLE `ext_task_auditors` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建日期',
  `ent_code` varchar(64) COLLATE utf8mb4_general_ci NOT NULL COMMENT '企业编码',
  `record_id` varchar(64) COLLATE utf8mb4_general_ci NOT NULL COMMENT '记录唯一recordId',
  `process_instance_id` varchar(255) COLLATE utf8mb4_general_ci NOT NULL COMMENT '流程实例id',
  `execution_id` varchar(64) COLLATE utf8mb4_general_ci NOT NULL COMMENT '执行实例id',
  `task_id` varchar(64) COLLATE utf8mb4_general_ci NOT NULL COMMENT '任务id',
  `task_def_key` varchar(255) COLLATE utf8mb4_general_ci NOT NULL COMMENT '流程任务节点定义key',
  `auditor` varchar(64) COLLATE utf8mb4_general_ci NOT NULL COMMENT '审核人、操作人',
  `action` varchar(255) COLLATE utf8mb4_general_ci NOT NULL COMMENT '审核操作',
  PRIMARY KEY (`id`),
  UNIQUE KEY `record_id` (`record_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1992 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='任务审核人扩展表';
